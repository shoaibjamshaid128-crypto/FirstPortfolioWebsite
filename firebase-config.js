...
import { getStorage } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-storage.js"; // <-- Yeh import add karni hai
...
export const storage = getStorage(app); // <-- Yeh export add karni hai
